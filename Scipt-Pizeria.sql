...
INSERT INTO CLIENTE
    (CODCLI, NOMCLI, APECLI, FECNACICLI, TELFCLI, DIRRECCLI, DNICLI, SEXCLI, CODUBI)
VALUES
    ("C001", "Andrés", "Avelino", '02-01-09', "984763098", "Av. Siempre viva", "83792017", "M", "140401"),
    ("C002", "Carlos", "Guerrero", '01-01-10', "934063098", "Av. Los Rosales", "80012017", "M", "140411"),
    ("C003", "Ana", "Quispe", '98-01-11', "920017658", "Av. Ramos", "39017017", "F", "140408"),
    ("C004", "Javier", "Guzman", '84-01-12', "939992808", "Av. Iquitos", "13812017", "F", "140407"),
    ("C005", "Carla", "Campos", '94-01-13', "937810209", "Av. Los Olivos", "80013990", "F", "140414"),
    ("C006", "Esteban", "Perez", '98-01-14', "934228170", "Av. Lima", "36618729", "M", "140413"),
    ("C007", "Paula", "Guerrero", '99-01-15', "934022009", "Av. Junin", "10092846", "F", "140406"),
    ("C008", "Ramon", "Sanchez", '89-01-16', "933966098", "Av. Nazca", "80012017", "M", "140416"),
    ("C009", "Julia", "Ramos", '90-01-17', "920018098", "Av. 28 de Julio", "12387787", "F", "140409"),
    ("C010", "Marta", "Gonzales", '97-01-18', "927748390", "Av. Italia", "80588479", "F", "140403");
    
-- Insertar registro a la tabla VENDEDOR
INSERT INTO VENDEDOR
    (CODVEN, NOMVEN, APEVEN, SEXVEN, TELFVEN, DIRRECVEN, DNIVEN)
VALUES
    ("V001", "Renato", "Sanchez", "M", "928982706", "Av. Lima", "73934789"),
    ("V002", "Fernanda", "García", "F", "926661198", "Av. Campos", "82201876"),
    ("V003", "Gabriel", "Cahuin", "M", "944587375", "Av. Lima", "76399207"),
    ("V004", "Andrés", "Casas", "M", "984388093", "Av. Los olvidos", "85530091"),
    ("V005", "Paul", "Balboa", "M", "984762236", "Av. Ramires", "33662817"),
    ("V006", "Julian", "Huamán", "M", "982210987", "Av. Las Peras", "45678234"),
    ("V007", "Rosa", "Quispe", "F", "966789045", "Av. La Parca", "87609023"),
    ("V008", "Isabel", "Gomez", "F", "978726371", "Av. Siempre Viva", "45637892"),
    ("V009", "Carol", "Espinoza", "F", "955392761", "Av. Olivos", "34526719"),
    ("V010", "Marco", "Huaman", "M", "922001926", "Av. Los Jardines", "44590387");
